...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI, KC_ENT,  KC_SPC,  KC_BSPC, LOWER,   RAISE,   XXXXXXX, XXXXXXX, KC_F13,  KC_F14   \
  ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL , KC_END , KC_PGDN,                   XXXXXXX, KC__VOLDOWN, KC__MUTE, KC__VOLUP, XXXXXXX, XXXXXXX, \
